...
function FulfillmentDAO(targetId, params) {
  // if (!(this instanceof FulfillmentDAO)) return new FulfillmentDAO(targetId);
  this.targetId = targetId;
  this.params = params;
}

FulfillmentDAO.prototype.create = function (object) {
...
FulfillmentDAO.prototype.del = function (testCaseId) {
  return new Promise((resolve, reject) => {
    var del = require('del');
